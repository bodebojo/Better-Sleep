...
tellraw @s ""
tellraw @s ""
tellraw @s ["",{"text":"Manage Datapack","color":"dark_aqua"},{"text":" [","color":"dark_gray"},{"text":"START","color":"dark_green","clickEvent":{"action":"run_command","value":"/function better_sleep:control/start"},"hoverEvent":{"action":"show_text","contents":[{"text":"Start the Datapack","color":"gray"}]}},{"text":"]","color":"dark_gray"},{"text":" [","color":"dark_gray"},{"text":"RESET","color":"dark_red","clickEvent":{"action":"run_command","value":"/function better_sleep:control/reset"},"hoverEvent":{"action":"show_text","contents":[{"text":"Reset the Datapack","color":"gray"}]}},{"text":"]","color":"dark_gray"},{"text":" [","color":"dark_gray"},{"text":"PAUSE","color":"dark_blue","clickEvent":{"action":"run_command","value":"/function better_sleep:control/pause"},"hoverEvent":{"action":"show_text","contents":[{"text":"Pause the Datapack","color":"gray"}]}},{"text":"]","color":"dark_gray"},{"text":" [","color":"dark_gray"},{"text":"CONTINUE","color":"gold","clickEvent":{"action":"run_command","value":"/function better_sleep:control/continue"},"hoverEvent":{"action":"show_text","contents":[{"text":"Continue the Datapack","color":"gray"}]}},{"text":"]","color":"dark_gray"}]
# Divider Line
