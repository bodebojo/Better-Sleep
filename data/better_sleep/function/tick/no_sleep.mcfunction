...
execute as @a[scores={better_sleep.no_sleep=1}] unless score @s better_sleep.no_sleep = @s better_sleep.no_sleep_old run tellraw @s {"text": "No Sleep Activated", "color": "gold"}

# Send toggled off message
execute as @a[scores={better_sleep.no_sleep=0}] unless score @s better_sleep.no_sleep = @s better_sleep.no_sleep_old run tellraw @s {"text": "No Sleep Deactivated", "color": "gold"}
