...
# Actual Config:
# Divider Line
tellraw @s [{"color": "dark_gray", "text": "=================="}, {"color": "dark_green", "text": " Better Sleep V2 ", "clickEvent": {"action": "open_url", "value": "https://modrinth.com/project/better-sleep"}}, {"color": "dark_gray", "text": "=================="}]
