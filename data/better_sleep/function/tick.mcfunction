# No sleep title
execute if score &better_sleep.no_sleep_count better_sleep.numbers matches 1 run title @a[scores={better_sleep.sleeptimer=1..}] actionbar [{"color":"gold", "selector": "@a[scores={better_sleep.no_sleep=1..}]"}, {"color":"white","text": " doesn't want you to sleep"}]
execute if score &better_sleep.no_sleep_count better_sleep.numbers matches 2.. run title @a[scores={better_sleep.sleeptimer=1..}] actionbar [{"color": "gold", "selector": "@a[scores={better_sleep.no_sleep=1..}]"}, {"color": "white", "text": " dont want you to sleep"}]
...
execute if score &online_players better_sleep.numbers < &amount_to_sleep better_sleep.numbers if score &sleep_amount better_sleep.numbers matches 1.. run scoreboard players set &skipping_night better_sleep.numbers 1
